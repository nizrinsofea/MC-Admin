                ...
                <div class="form-group">
                  ...
                  <select id="category" class="form-control" name="category">
                    @foreach($categories as $categories)
                      <option value="{{ $data->credithr }}">{{ $categories['KEY'][1]['VALUE'] }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <label for="created_by">Enter Course Code for</label>
                  <h6>{{ $data->coursetitle }}</h6>
                  <input name="created_by" class="form-control" value="" id="" readonly>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Add to Moodle</button>
                </div>
              </div>
            </div>
          </div> -->
